<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "d431d098e8879f15f2114451b17581c3c3513465a4"){
                                        if ( file_put_contents ( "/var/www/vhosts/spacegm.com/art.spacegm.com/wp-content/themes/flatsome/template-parts/header/page-loader.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/vhosts/spacegm.com/art.spacegm.com/wp-content/plugins/wpide/backups/themes/flatsome/template-parts/header/page-loader_2018-11-05-07.php") )  ) ){
...
?>
<div id="page-loader" class="page-loader fixed fill z-top-3 <?php if($color == 'dark') echo 'nav-dark dark'; ?>">
	...
	<div class="page-loader-inner" id="page-loader-inner">
	    ...
	    <section class="wrapper1" id="wrapper1">
